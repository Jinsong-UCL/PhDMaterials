...
phi_vq = ones(2,1)*0.5*xi.^2-0.5*((q^2+q*phi_ij')*ones(1,ngrid)-(2*q+phi_ij')*1i*xi);
...
% 
cputime = toc;
fprintf('%22s%14.10f%14.3f\n','Call price, CF',call_option_price,cputime)
% 
% figure(1)
