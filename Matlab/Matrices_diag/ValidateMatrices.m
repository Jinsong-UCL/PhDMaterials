...
paramStruct.nblocks = 1000;
paramStruct.npaths =  1000;
...
for K = [0.9 0.95 1 1.05 1.1]
    ...
    %parfor n = [1 2]
        ...
        fprintf('&& %3d & %4.6f & %4.6f & %4.6f  ',n*50 ,simulated_call,scMC,abs(call_price-simulated_call));
...
%         fprintf('&& %3d & %4.6f & %4.6f & %4.6f  ',n*50 ,simulated_put,spMC,abs(put_price-simulated_put));
