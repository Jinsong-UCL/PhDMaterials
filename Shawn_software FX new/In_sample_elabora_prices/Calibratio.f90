...
!! Note that the unit is a day rember that a year is made by 261 daily observations on Bloomberg.
   ...
   maxdist=264-22
	...
	open(4,file='price_in_sample_call_put_15_02_def10.txt',status='unknown')
      open(5,file='param_rec_call_put_15_02_def10.txt',status='unknown')
      
        open(21,file='param_rec_call_put_15_02_def9.txt',status='unknown')
