...
%load param_implied_new.txt;
%par_im=param_implied_new;
%load value_implied_new.txt
%imp=value_implied_new;
%nptime=1;
%nobs=30-nptime+1

load price_in_sample_call_put_v1.txt
dati_all=price_in_sample_call_put_v1;


load price_in_sampleH0_call_put.txt
dati_allH0=price_in_sampleH0_call_put;
