...
load param_rec_call_put_v1.txt
par=param_rec_call_put_v1;
...
%xlabel('    time to maturity  (days)','FontSize',14)
xlabel('    day index','FontSize',14)
axis([min(min(timetomat))  max(max(timetomat)) 5.0 25])
...
%xlabel('    time to maturity  (days)','FontSize',14)
xlabel('    day index','FontSize',14)
axis([min(min(timetomat))  max(max(timetomat)) 0.0005 0.0025])
...
%xlabel('    time to maturity  (days)','FontSize',14)
xlabel('    day index','FontSize',14)
axis([min(min(timetomat))  max(max(timetomat)) 0.0 0.41])
...
xlabel('    day index','FontSize',14)
%
axis([min(min(timetomat))  max(max(timetomat)) 0. 0.31])
