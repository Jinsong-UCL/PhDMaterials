...
%% ultimo buono
load price_in_sample_call_put_25_02_def10.txt
dati_all1=price_in_sample_call_put_25_02_def10;
...
for is=1:nstr
  ...
  ermeanput(is)=mean(errput(is,n1:n2));
    ermeancallH0(is)=mean(errcallH0(is,n1:n2));
  ermeanputH0(is)=mean(errputH0(is,n1:n2));
end
