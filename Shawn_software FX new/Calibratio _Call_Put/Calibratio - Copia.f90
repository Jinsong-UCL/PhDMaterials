...
!! Note that the unit is a day rember that a year is made by 261 daily observations on Bloomberg.
	...
	open(4,file='price_in_sample_call_put_15_02_def4.txt',status='unknown')
      open(5,file='param_rec_call_put_15_02_def4.txt',status='unknown')
      
        open(21,file='param_rec_call_put_def1_starting.txt',status='unknown')
...
! param(11)= rho_2 (correlation coefficient)
           ...
           param(1)=  0.2983725824372238     
           param(2)=  9.997175729334047E-002
           param(3)=  0.176946020551277     
           param(4)=  9.177193477969983E-002
          param(5)=   8.23029212266514     
           param(6)= -0.647044427139981     
           param(7)=  8.194569972300056E-002
           param(8)= 1.13278263896439829     
           param(9)=  2.001667186064108E-003
          param(10)=   34.5856384547843 
        !   param(10)=   30.5856384547843
          param(11)= -0.904964990157810     
          param(12)=  0.6915584155021121     


             param(1)=  0.190089351078237     
           param(2)=  0.102320292808823     
           param(3)=  0.192821186805060     
           param(4)=  7.826401609868165E-002
           param(5)=   7.01307327927225     
           param(6)= -0.666481204466052     
           param(7)=8.203721866466708E-002
           param(8)= -9.233979768475946E-002
           param(9)=  1.834480949032811E-003
          param(10)=   67.5709198692609     
          param(11)= -0.905005565506604     
          param(12)=  0.0604875295182736     
          ...
          enddo
           ...
           param( 1)=  1.100000000000000E+000
           param(2)=  0.181942855714698     
           param(3 )= 0.139672423437937     
           param(4)=  9.950380281497919E-001
           param(5)=   1.05099004084662     
           param(6)= -0.202970179889074     
           param(7)=  0.0100000000000000E+000
           param(8)=  4.706732666264172E-0
           param(9)=  0.4100000000000000E+000
          param(10)=  1.100000000000000E+000
          param(11)=  -0.8100000000000000E+000
          param(12)=  0.26100000000000000E+000

                    param( 1)=  0.728342810706312     
           param(2)=  0.182621127998860     
           param(3)=  0.106548287643037     
           param(4)=  0.450126677982531     
           param(5)=  0.655900632614947     
           param(6)= -0.976317317129727     
           param(7)=  9.800204156336220E-003
           param(8)=  0.209069713635001     
           param(9)=  0.438041631931449     
          param(10)=  3.632560592691517E-002
          param(11)= -0.809375060650246     
          param(12 )= 0.249954163690055     
       !     param(10)=34.0
        
       param(  1)=  0.720145974347763     
           param(2 )= 0.182713497927513     
           param(3)=  0.106687224095823     
           param(4)=  0.450881334964881     
           param(5)=  0.656540162348156     
           param(6)= -0.976233707949899     
          param( 7)=  9.800123678167214E-003
           param(8)=  3.333080158752228E-007
           param(9)=  0.437384162253689     
          param(10)=  3.629409783201872E-002
          param(11)= -0.809373661465329     
          param(12)=  0.250182787818713   
       ...
       param(  1)=  0.720145974347763     
           ...
           param(6)= -0.976233707949899     
          param( 7)=  9.800123678167214E-003
           param(8)=  3.333080158752228E-002
           param(9)=  0.437384162253689     
          param(10)=  3.629409783201872E-002
          param(11)= -0.809373661465329     
          param(12)=  0.250182787818713   
       
            param(1)=  0.596954909442166     
           param(2)=  0.183153094017815     
           param(3)=  0.108920248472528     
           param(4)=  0.464037500155074     
           param(5)=  0.668231250197247     
           param(6)= -0.974840577669716     
           param(7)=  9.814612769849476E-003
           param(8)=   2.50079360451519     
           param(9)=  0.445345439521258     
           param(10)=  3.691974157274894E-002
           param(11)= -0.809592940777821     
           param(12)=   1.89949283832409  
       ...
       param(  1)=  0.720145974347763     
          ...
          param(10)=  3.629409783201872E-002
          param(11)= -0.809373661465329     
          param(12)=  1.5098250182787818713   
	 ...
	 do jj=1,nptime
      do ik = 1, np
	     !sommanew=sommanew+(optvalc(jj,ik)-callval(idx(jj),ik))**2
                        auxop=optvalc(jj,ik)
	              sommanew=sommanew+1.d0*(auxop-callval(idx(jj),ik))**2/callval(idx(jj),ik)**2
                  auxpp=optvalp(jj,ik)
...
999 continue    
	...
	write(*,*) 'vecchia=',sommaold,' definitiva=',somma
2011  continue
