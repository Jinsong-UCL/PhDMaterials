...
!! Note that the unit is a day rember that a year is made by 261 daily observations on Bloomberg.
	...
	open(4,file='price_in_sampleH0_callpp2.txt',status='unknown')
      open(5,file='param_recH0_callpp2.txt',status='unknown')
...
! param(11)= rho_2 (correlation coefficient)
           ...
           param(1)=  0.000000000000000E+000
           ...
           param(7)=  0.000000000000000E+000
           param(8)=  8.203499101914119E-002
           param(9)=  0.000000000000000E+000
          param(10)=  0.000000000000000E+000
          param(11)=  0.000000000000000E+000
          param(12)=  0.000000000000000E+000
