...
load param_rec_call_put_25_02_def10.txt
par=param_rec_call_put_25_02_def10;
...
pr=price_in_sample_call_put_15_02_def10;
...
axis([min(min(timetomat)) max(max(timetomat)) 0.0 0.015]) 
...
%xlabel('    time to maturity  (days)','FontSize',14)
xlabel('    day index','FontSize',14)
axis([min(min(timetomat))  max(max(timetomat)) 0. 0.06])
...
%xlabel('    time to maturity  (days)','FontSize',14)
xlabel('    day index','FontSize',14)
axis([min(min(timetomat))  max(max(timetomat)) 1 5])
...
%xlabel('    time to maturity  (days)','FontSize',14)
xlabel('    day index','FontSize',14)
axis([min(min(timetomat))  max(max(timetomat)) 0.0 0.006])
...
%xlabel('    time to maturity  (days)','FontSize',14)
xlabel('    day index','FontSize',14)
axis([min(min(timetomat))  max(max(timetomat)) -1.0 -0.6])
...
%xlabel('    time to maturity  (days)','FontSize',14)
xlabel('    day index','FontSize',14)
axis([min(min(timetomat))  max(max(timetomat)) 1 4])
...
%xlabel('    time to maturity  (days)','FontSize',14)
xlabel('    day index','FontSize',14)
axis([min(min(timetomat))  max(max(timetomat)) 0.00 0.04])
...
xlabel('    day index','FontSize',14)
axis([min(min(timetomat))  max(max(timetomat)) 0.5 2.5])
