...
!! Note that the unit is a day rember that a year is made by 261 daily observations on Bloomberg.
	...
	open(4,file='price_in_sample_call_put.txt',status='unknown')
      open(5,file='param_rec_call_put.txt',status='unknown')
...
!!! e' fondamentale prendere negativo questo tasso         
         ...
         param(12)=0.1d0
           ...
           param(1)= 0.0001000000000000E+000
           param(2)=  0.185868617534917     
           param(3)=  9.997045542335960E-002
           param(4)=  1.028704658470792E-002
           param(5)=  0.965243846864233     
           param(6)= -0.305427881219829     
           param(7)=0.000010000000000E+000
           param(8)=126102118895776     
           param(9)=  0.0000100000000000E+000
          param(10)=  0.0000100000000000E+000
          param(11)=  0.0000010000000000E+000
          param(12)=  0.0000010000000000E+000
         ...
         param( 1 )=  0.2242667567689     
          ...
          param( 5)=   8.26972091920758     
           ...
           param(8)=  -1.973025717244276E-001
