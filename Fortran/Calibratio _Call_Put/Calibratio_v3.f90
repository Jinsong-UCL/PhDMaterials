...
!! Note that the unit is a day rember that a year is made by 261 daily observations on Bloomberg.
	...
	open(4,file='price_in_sample_call_put_15_02_def2.txt',status='unknown')
      open(5,file='param_rec_call_put_15_02_def2.txt',status='unknown')
...
! param(11)= rho_2 (correlation coefficient)
           ...
           param(1)=  0.983725824372238     
           param(2)=  9.997175729334047E-003
          ...
          param(5)=   8.23029212266514     
           ...
           param(8)= -0.13278263896439829     
           param(9)=  4.001667186064108E-003
          param(10)=   10.5856384547843 
        !   param(10)=   30.5856384547843
          param(11)= -0.904964990157810     
          param(12)=  0.06915584155021121     
